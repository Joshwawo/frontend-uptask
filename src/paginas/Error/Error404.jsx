...
const Error404 = () => {
  return (
    <div className="">
      <div className="  bg-[#FFFFFFDE] dark:bg-gray-100 flex items-center mt-32 xl:mt-60">
        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700 mx-auto">
          <div className="max-w-md">
            <div className="text-5xl font-dark font-bold text-black/70">
              404
            </div>
            <p className="text-2xl md:text-3xl font-light leading-normal text-gray-500">
            ...
            <Link
              to={"/proyectos"}
              className="uppercase text-sm font-bold tracking-wide border  border-gray-300 dark:text-gray-500  p-3 rounded-lg w-full hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-colors duration-200"
            >
              volver a proyectos
            </Link>
          </div>
